          ...
          <div className="order__grid">
            <div className="order__block">
              ...
              {Steps.map((step, key) => {
                return (
                  <div
                    className="order__steps"
                    onMouseOver={lowOpacity}
                    onMouseLeave={fullOpacity}
                    key={key}
                  >
          ...
          <div className="container">
            <div className="contact__grid">
              ...
              <div className="contact__box">
                <h3>Home Address </h3>
                <p>
                  435 Brgy Sta. Monica <br /> San Pablo City, Laguna 4000
                </p>
              </div>
              <div className="contact__box">
                <h3>Mobile</h3>
              ...
              <div className="contact__box">
                <h3>Map Location</h3>
                <button onClick={handleMapLocation}>
                  <RiRoadMapFill /> <span> View Map </span>
                </button>
              </div>
            </div>
          </div>
